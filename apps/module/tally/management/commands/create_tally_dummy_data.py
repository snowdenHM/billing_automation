    ...
    def create_analyzed_expense_bills(self, organization, expense_bills, ledgers):
        ...
        for i, bill in enumerate(expense_bills):
            if bill.status in ["Analysed", "Verified", "Synced"]:
                ...
                # Create expense products for this analyzed bill
                expense_items = [
                    {"details": "Office rent for August 2025", "amount": "5000.00", "ledger_idx": 0},
                ]
                ...
                for item in expense_items:
                    if Decimal(item["amount"]) > 0:
                        TallyExpenseAnalyzedProduct.objects.create(
                            ...
                            chart_of_accounts=expense_ledgers[item["ledger_idx"] % len(expense_ledgers)],
        ...
        self.stdout.write(f'Created {len(analyzed_bills)} analyzed expense bills with products')
